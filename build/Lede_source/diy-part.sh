...
sed -i 's/Hello World/VisualSSR/g'  package/GWen124/luci-app-vssr/luasrc/controller/vssr.lua
sed -i 's/"Cloudflare Speed Test"/"Cloudflare"/g' package/GWen124/luci-app-cloudflarespeedtest/po/zh-cn/cloudflarespeedtest.po
